...
<body>
    ...
    <div class="m-auto pt-20">
        ...
        <div class="pb-8">
            ...
            <div class="bg-red-500 font-bold rounded-t px-4 py-2 text-white">
        ...
        <form
            ...
            <textarea name="body" class="py-20 bg-transparent block border-b-2 w-full h-60 text-xl outline-none">
                {{$post->body}}
            </textarea>
